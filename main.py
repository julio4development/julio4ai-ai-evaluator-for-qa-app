...
st.set_page_config(
    page_title="AI Evaluator of Q&A App"
)
st.title("AI Evaluator of Q&A App")

with st.expander("Evaluate the quality of Q&A APP"):
    st.write("""
        To evaluate the quality of a Q&A app, we will
...
if len(result):
    ...
    st.info(response["graded_outputs"][0]["text"])
